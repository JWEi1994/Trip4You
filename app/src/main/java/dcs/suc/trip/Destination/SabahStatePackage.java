...
public class SabahStatePackage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sabah_state_package);
    ...
    private void viewSabahPackages() {
        progressDialog = new ProgressDialog(SabahStatePackage.this);
        progressDialog.setMessage("Please Wait...");
        progressDialog.setCancelable(true);
        progressDialog.show();

        Request request = new Request.Builder()
                .url(Global.DOMAIN_NAME + "viewSabahPackages.php")
                .build();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(SabahStatePackage.this, "Connection Error", Toast.LENGTH_SHORT).show();
                    }
                });
            }
...
//                                    packages.setDep(jsonObject.getString("dep"));
                                ...
                                PackageAdapter packageAdapter = new PackageAdapter(SabahStatePackage.this, packagesArrayList);
                                listView.setAdapter(packageAdapter);


                            } else if (success.equals("0")) {
                                Toast.makeText(SabahStatePackage.this, "Failed,Please try again", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent i = new Intent(SabahStatePackage.this, PackageInfo.class);
