...
public class MalaccaStatePackage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malacca_state_package);
    ...
    private void viewMalaccaPackages() {
        progressDialog = new ProgressDialog(MalaccaStatePackage.this);
        progressDialog.setMessage("Please Wait...");
        progressDialog.setCancelable(true);
        progressDialog.show();

        Request request = new Request.Builder()
                .url(Global.DOMAIN_NAME + "viewMalaccaPackages.php")
                .build();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(MalaccaStatePackage.this, "Connection Error", Toast.LENGTH_SHORT).show();
                    }
                });
            }
...
//                                    packages.setDep(jsonObject.getString("dep"));
                                ...
                                PackageAdapter packageAdapter = new PackageAdapter(MalaccaStatePackage.this, packagesArrayList);
                                listView.setAdapter(packageAdapter);


                            } else if (success.equals("0")) {
                                Toast.makeText(MalaccaStatePackage.this, "Failed,Please try again", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent i = new Intent(MalaccaStatePackage.this, PackageInfo.class);
