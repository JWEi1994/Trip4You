...
public class KedahStatePackage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kedah_state_package);
    ...
    private void viewKedahPackages() {
        progressDialog = new ProgressDialog(KedahStatePackage.this);
        progressDialog.setMessage("Please Wait...");
        progressDialog.setCancelable(true);
        progressDialog.show();

        Request request = new Request.Builder()
                .url(Global.DOMAIN_NAME + "viewKedahStatePackage.php")
                .build();
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(KedahStatePackage.this, "Connection Error", Toast.LENGTH_SHORT).show();
                    }
                });
            }
...
//                                    packages.setDep(jsonObject.getString("dep"));
                                ...
                                PackageAdapter packageAdapter = new PackageAdapter(KedahStatePackage.this, packagesArrayList);
                                listView.setAdapter(packageAdapter);


                            } else if (success.equals("0")) {
                                Toast.makeText(KedahStatePackage.this, "Failed,Please try again", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent i = new Intent(KedahStatePackage.this, PackageInfo.class);
